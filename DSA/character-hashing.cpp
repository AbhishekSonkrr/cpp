...
int main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        // characterFreq[arr[i]]++; //use if there is no explicitly explained what type of character is
    }

    int q;
    char c;
    /*_________________________________________________________________________________
        why we don't use string c here because we have to look at individual character
