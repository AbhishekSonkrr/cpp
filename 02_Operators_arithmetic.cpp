...
/* == ARITHMETIC OPERATORS == */
    ...
    cout << "division:" << num1/num2 << endl;//RESULT: 0  (because num1 , num2 are integer so we get only inter par in result)
...
/* == TERNARY OPERATORS == */
    ...
    // COONDITION ? TASK1 : TASK2 {IF CONDTION IS TRUE THEN TASK1 EXECUTED ELSE TASK2}
